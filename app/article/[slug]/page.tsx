...
export default function ArticlePage() {
  ...
  useEffect(() => {
    async function fetchData() {
      if (!slug) return;
      try {
        // Query لجلب المقال (post أو article)
  ...
  if (loading) return <div style={{padding: "100px", textAlign: "center"}}>Chargement de l'article...</div>;

  if (error || !article) return (
    <div style={{padding: "100px", textAlign: "center", fontFamily: "sans-serif"}}>
      <h2 style={{color: "red"}}>⚠️ {error || "Article introuvable"}</h2>
